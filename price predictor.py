...
st.title("Real Estate House & Flat Price Predictor")
...
sector = st.selectbox('Property Type',sorted(df['sector'].unique().tolist()))
bedrooms = st.selectbox('Number of bedroom',sorted(df['bedRoom'].unique().tolist()))
...
if st.button('Predict'):
    ...
    st.text("The price of the flat or house between {} Cr and {} Cr".format(round(low_price, 2), round(high_price, 2)))
